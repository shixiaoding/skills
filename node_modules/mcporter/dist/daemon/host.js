...
import { createLogContext, disposeLogContext, formatError, logEvent, shouldLogServer, } from './log-context.js';
import { buildErrorResponse, ensureManaged, evictIdleServers, markActivity, } from './request-utils.js';
export async function runDaemonHost(options) {
    ...
    const server = net.createServer({ allowHalfOpen: true }, (socket) => {
        ...
        const tryHandle = () => {
            ...
            void handleSocketRequest(trimmed, socket, runtime, managedServers, activity, {
                ...
                configMtimeMs,
            }, logContext, shutdown, parsedRequest);
        };
    ...
    await fs.writeFile(options.metadataPath, JSON.stringify({
        pid: process.pid,
        socketPath: options.socketPath,
        configPath: options.configPath,
        configLayers,
...
export async function __testProcessRequest(rawPayload, runtime, managedServers, activity, metadata, logContext, preParsedRequest) {
